...
let CONTACTS = [ // в переменной CONTACTS будет хранится данные нашего обьекта
  {id: v4(), name: 'Victor', value: '+37369669676', marked: false} // обьект с нашими данными (Имя, значение, и marked если мы отмечали его)
